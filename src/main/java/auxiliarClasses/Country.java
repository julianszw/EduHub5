...
public enum Country{
    ...
    URUGUAY("Uruguay"),
    USA("United States of America", "^[0-9]{9}$"),
    ...
    private static final String DEFAULT_ID_REGEX = "^[a-zA-Z0-9]{1,10}$";

    Country(String name, String regex) {
        this.name = name;
        this.regex = regex;
    }

    Country(String name) {
        this(name, DEFAULT_ID_REGEX);
    }
